...
import { GetCustomerCDRsResponse } from '../../../transport/resultTypes';
 ...
 * @returns
 */
export async function getCustomerCDRs(
	...
	try {
		...
		const responseData = await apiRequest.call(
			this, 'getCustomerCDRs', parameters
		) as GetCustomerCDRsResponse;
