...
export const addDIDDescription: DIDProperties = [
	...
	incoming_did('addDID', true),
	translation_rule('addDID', false),
	// cld_translation_rule - CLD translation rule. String. Optional. (removed since 5.1)
	cli_translation_rule('addDID', false),
	description('addDID', false),
	i_ivr_application('addDID', false),
	i_account('addDID', false),
	...
	i_vendor('addDID', false),
	i_connection('addDID', false),
